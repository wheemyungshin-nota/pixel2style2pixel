...
DATASETS = {
	...
	'zigbang_alpha_300': {
		'transforms': transforms_config.ZigbangTransforms,
		'train_source_root': dataset_paths['zigbang_alpha_300_rgb'],
		'train_target_root': dataset_paths['zigbang_alpha_300_ir'],
		'test_source_root': dataset_paths['zigbang_alpha_zigzag_rgb'],
		'test_target_root': dataset_paths['zigbang_alpha_zigzag_ir'],
	},
	'zigbang_alpha_500': {
		'transforms': transforms_config.ZigbangTransforms,
		'train_source_root': dataset_paths['zigbang_alpha_500_rgb'],
		'train_target_root': dataset_paths['zigbang_alpha_500_ir'],
		'test_source_root': dataset_paths['zigbang_alpha_zigzag_rgb'],
		'test_target_root': dataset_paths['zigbang_alpha_zigzag_ir'],
	},
	'zigbang_alpha_700': {
		'transforms': transforms_config.ZigbangTransforms,
		'train_source_root': dataset_paths['zigbang_alpha_700_rgb'],
		'train_target_root': dataset_paths['zigbang_alpha_700_ir'],
		'test_source_root': dataset_paths['zigbang_alpha_zigzag_rgb'],
		'test_target_root': dataset_paths['zigbang_alpha_zigzag_ir'],
	},
	'zigbang_alpha_900': {
		'transforms': transforms_config.ZigbangTransforms,
		'train_source_root': dataset_paths['zigbang_alpha_900_rgb'],
	...
	'zigbang_with_margin_alpha_500': {
		...
		'test_source_root': dataset_paths['zigbang_with_margin_alpha_300_rgb'],
		'test_target_root': dataset_paths['zigbang_with_margin_alpha_300_ir'],
	},
}
